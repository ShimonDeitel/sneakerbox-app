...
final class SneakerboxUITests: XCTestCase {
    ...
    func testAddEntryFlow() {
        ...
        titleField.tap()
        titleField.typeText("New Pair")
        app.buttons["saveButton"].tap()
        XCTAssertTrue(app.staticTexts["New Pair"].waitForExistence(timeout: 2))
    }
